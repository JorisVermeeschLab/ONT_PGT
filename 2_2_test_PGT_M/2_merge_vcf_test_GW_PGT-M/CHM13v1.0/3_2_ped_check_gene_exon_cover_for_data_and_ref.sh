...
# chmod 755 3_2_ped_check_gene_exon_cover_for_data_and_ref.sh
# nohup 3_2_ped_check_gene_exon_cover_for_data_and_ref.sh > 3_2_ped_check_gene_exon_cover_for_data_and_ref.sh.log 2>&1 &
# 
# 
