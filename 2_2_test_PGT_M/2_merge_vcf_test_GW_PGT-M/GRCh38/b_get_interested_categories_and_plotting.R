...
data_for_selection<-read.table(file=paste("a_",sample,"_haplotype_match_stats.txt",sep=""),header = T)
...
# consider rep_3_Ha rep_3_Hb rep_4_Ha rep_4_H 
...
write.table(sorted_trio_success,file=paste("b_",sample,"_trio_success.txt",sep=""),row.names = F,quote = F)
