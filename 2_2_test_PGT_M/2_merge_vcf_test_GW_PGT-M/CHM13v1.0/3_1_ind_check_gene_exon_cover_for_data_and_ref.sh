...
# chmod 755 3_1_ind_check_gene_exon_cover_for_data_and_ref.sh
# nohup 3_1_ind_check_gene_exon_cover_for_data_and_ref.sh > 3_1_ind_check_gene_exon_cover_for_data_and_ref.sh.log 2>&1 &
# 
# 
module load BEDTools

uniq_exon_protein_coding_bed="/lustre1/project/stg_00019/research/yan/nanopore_data/00_02_resource_GTF/T2T-CHM13v1.0/noYM_uniq_exon_protein_coding.sorted.merged.bed"
...
echo -e data"\t"len_snv_lim"\t"max_matchperc_lim"\t"exon_coverage"\t"gene_coverage>$wkdir/ind_gene_exon_coverage.txt
...
# 102576904
sum_exon_protein_coding=102576904
#awk '{sum_bp+=$3-$2}END{print sum_bp}' $uniq_gene_protein_coding_bed
# 1290245558
sum_gene_protein_coding=1290245558
...
echo -e data"\t"min_max_matchperc_Ha"\t"min_max_matchperc_Hb"\t"perc_blocks_max_matchperc_Ha_Hb_1>$wkdir/ind_min_max_matchperc.txt
for data in "independent_mc_MDA_24x_LSK114" "independent_sc_MDA_22x_LSK114" "independent_bulk_no_24x_LSK114" 
do
cd $wkdir_ind/$data
