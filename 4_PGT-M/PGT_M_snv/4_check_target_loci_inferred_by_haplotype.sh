...
do
wkdir="/lustre1/project/stg_00019/research/yan/nanopore_data/01_03_human_PGT_families/ONT2/PGT_M_snv_patmat_match_new_model/$sample"
cd $wkdir
...
# output all SNP in the unit
info="/lustre1/project/stg_00019/research/yan/nanopore_data/01_03_human_PGT_families/ONT2/PGT_M_snv_patmat_match_new_model/0_get_unfiltered_block_info/a_FM_gt_sep_ps_imputed.txt"
