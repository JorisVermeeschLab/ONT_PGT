...
while($record=<CHECKBOOK>){
  ...
  system qq(R --slave --args $Program_Folder_Path,$Sample_Out_Folder_Path,$Sample_Label,$target,$assembly < $Program_Folder_Path/lib/R/NanoGLADIATORNormalizationGenome.R);
