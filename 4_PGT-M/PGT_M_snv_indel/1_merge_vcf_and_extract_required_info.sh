...
wkdir="/lustre1/project/stg_00019/research/yan/nanopore_data/01_03_human_PGT_families/ONT2/PGT_M_snv_indel_patmat_match_new_model"

F_phased_vcf="/lustre1/project/stg_00019/research/yan/nanopore_data/01_03_human_PGT_families/ONT2/ONT2_F/6_Clair3/whatshap_phasing_GQ2_include_indel/phased.filtered.merge_output.vcf.gz"
M_phased_vcf="/lustre1/project/stg_00019/research/yan/nanopore_data/01_03_human_PGT_families/ONT2/ONT2_M/6_Clair3/whatshap_phasing_GQ2_include_indel/phased.filtered.merge_output.vcf.gz"

for data in ONT2_E04 ONT2_E06 ONT2_E20
do

E_ped_phased_vcf="/lustre1/project/stg_00019/research/yan/nanopore_data/01_03_human_PGT_families/ONT2/$data/7_Clair3_trio_newmodel/whatshap_phasing_include_indel/$data.phased.vcf.gz"
